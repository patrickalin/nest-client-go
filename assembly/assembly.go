...
func tmplNestTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/nest.txt", size: 1109, mode: os.FileMode(420), modTime: time.Unix(1499458078, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
